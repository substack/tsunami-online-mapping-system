...
cat << EOM
<HTML>
<HEAD><TITLE>Delete deformation models</TITLE>
...
function Finalize(theSelFrom)
{
  ...
  if(str == "")
    ...
    window.open('/cgi-bin/priv/delete_deformation_final.cgi'+'?'+str,'toolbar=no,location=no,directories=no,status=no,menubar=no,width=500,height=700');
}
...
<tr>        <th WIDTH=200>Available deformations</th>  <th WIDTH=100></th>  <th WIDTH=200>Candidates for removal</th> </tr>
	<tr>
		<td>
