...
poly='''<Placemark>
    ...
    <![CDATA[
    <p align="center"><a href="http://burn.giseis.alaska.edu/cgi-bin/viewer.cgi?grid=PA02&lat=%(ii_lat).d&lon=%(ii_lon).d&field=Z">Sea Level History</p>
