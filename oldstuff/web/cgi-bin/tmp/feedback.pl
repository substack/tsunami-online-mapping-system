...
print <<EndStart;
	...
	<title>Thank You</title>
        <meta http-equiv="refresh" content="3;url=http://burn.giseis.alaska.edu/banner.html">
	</head>
	
	<body bgcolor="#ffffff" text="#000000">
	
	<p>Your feedback has been received. Thank  you for sending it.</p>
